...
class PRAKA(Finetune):
    def __init__(self, backbone, feat_dim, num_class, **kwargs):
        ...
        self.old_model = None
        self.task_idx = 0
        self.class_set = list(range(self.kwargs["total_nc"]))
    ...
    def observe(self, data):
        ...
        if self.task_idx == 0:
            ...
            old_class = len(self.class_set[:self.kwargs["init_cls_num"] + (self.task_idx - 1) * self.task_size])
    ...
    def _compute_loss(self, imgs, joint_labels, labels, old_class=0):
        ...
        '''
        # Feature extraction
        feature = self.model.feature(imgs)['features']
        ...
        if old_class == 0:
            ...
            feature_old = self.old_model.feature(imgs)['features']
    ...
    def protoSave(self, model, loader, current_task):
        ...
        with torch.no_grad():
            for i, batch in enumerate(loader):
                ...
                feature = model.feature(images.to(self.device))['features']
